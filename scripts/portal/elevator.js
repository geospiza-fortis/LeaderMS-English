...
function enter(pi) {
  if (pi.getPlayer().getMapId() == 222020100) {
    if (
      ...
      pi.playerMessage(
        "The elevator is not available on this floor at this time. Please try again later."
      );
      return false;
    }
    ...
    pi.playerMessage(
      "You found a bug! Please report this bug using the @bug command."
    );
    return false;
  }
}
