...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      cm.sendNext(
        "What's up? I drive the Regular Cab. If you want to go from town to town safely and fast, then ride our cab. We'll glady take you to your destination with an affordable price."
      );
    } else if (status == 1) {
