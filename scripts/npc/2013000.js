...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (cm.getPlayer().getMapId() == 200080101) {
      if (status == 0) {
        cm.sendSimple(
          "Hello I am Wonky the Fairy. What would you like to do today?#b\r\n#L0#Apply for entrance.#l\r\n#L1#Give Wonky something to eat.#l"
        );
        ...
        if (cm.getParty() == null) {
          // no party
          cm.sendOk(
            "Talk to me after you've formed a party. And also #r#eGIVE ME FOOD!!#n"
          );
          cm.dispose();
          return;
        }
        if (!cm.isLeader()) {
          ...
          if (party.size() < minPlayers || party.size() > maxPlayers) {
            ...
            for (var i = 0; i < party.size() && next; i++) {
              ...
              if (
                party.get(i).getJobId() == 100 ||
                party.get(i).getJobId() == 110 ||
                party.get(i).getJobId() == 111 ||
                party.get(i).getJobId() == 120 ||
                party.get(i).getJobId() == 121 ||
                party.get(i).getJobId() == 130 ||
                party.get(i).getJobId() == 131
              ) {
                numOfWarriors += 1;
              }
              if (
                party.get(i).getJobId() == 200 ||
                party.get(i).getJobId() == 210 ||
                party.get(i).getJobId() == 211 ||
                party.get(i).getJobId() == 220 ||
                party.get(i).getJobId() == 221 ||
                party.get(i).getJobId() == 230 ||
                party.get(i).getJobId() == 231
              ) {
                numOfMages += 1;
              }
              if (
                party.get(i).getJobId() == 300 ||
                party.get(i).getJobId() == 310 ||
                party.get(i).getJobId() == 311 ||
                party.get(i).getJobId() == 320 ||
                party.get(i).getJobId() == 321
              ) {
                numOfRangers += 1;
              }
              if (
                party.get(i).getJobId() == 400 ||
                party.get(i).getJobId() == 410 ||
                party.get(i).getJobId() == 411 ||
                party.get(i).getJobId() == 420 ||
                party.get(i).getJobId() == 421
              ) {
                numOfThiefs += 1;
              }
              if (
                party.get(i).getJobId() == 500 ||
                party.get(i).getJobId() == 510
              ) {
                numOfGMs += 1;
              }
            }
            if (levelValid < party.size() || inMap < party.size()) next = false;
          }
          if (next) {
            ...
            if (em == null) {
              ...
              if (
                ...
                //Checks the party so gives buff if needed
            ...
            cm.sendOk(
              "Either your party members are not all in the map, or they are not in the right level range."
            );
            cm.dispose();
          }
        }
        ...
        cm.sendSimple(
          "Aww cool what have you got for me?#b\r\n#L0#Ice Cream Pop#l\r\n#L1#Red Bean Sundae#l\r\n#L2#Salad#l\r\n#L3#Pizza#l\r\n#L4#Fried Chicken#l\r\n#L5#Nothing...#l#k"
        );
      } else if (status == 2) {
      ...
      if (status == 0) {
        cm.sendYesNo(
          "Would you like to exit the Party Quest?\r\nYou will have to start again next time..."
        );
      } else if (status == 1) {
