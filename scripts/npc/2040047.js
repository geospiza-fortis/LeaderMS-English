...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (cm.getPlayer().getMap().getId() == 922010000) {
      ...
      if (status == 0) {
        cm.sendYesNo(
          "You will need start from scratch if you want to try this mission after leaving this stage. Are you sure you want to leave this map?"
        );
      } else if (status == 1) {
