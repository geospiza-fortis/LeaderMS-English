  ...
  if (mode == -1) {
    ...
    if (playerStatus) {
      ...
      if (status == 0) {
        ...
        if (preamble == null) {
          cm.sendNext(
            "Hello, and welcome to the second stage of Ludibrium PQ. There are #r15#k boxes in here, break them to retrieve the passes, and give them to me, and I will open the portal. But be careful, one of them will lead you into a trap!"
          );
          ...
          if (complete != null) {
            ...
            if (cm.haveItem(4001022, 15) == false) {
              cm.sendNext(
                "I'm sorry, but you do not have all 15 passes needed to clear this stage."
              );
              cm.dispose();
            } else {
              cm.sendNext(
                "Congratulations on clearing the second stage! I will open the portal now."
              );
              clear(1, eim, cm);
      ...
      if (status == 0 && preamble == null) {
        ...
        cm.sendNext(
          "Hello, and welcome to the second stage of Ludibrium PQ. There are #r16#k boxes in here, break them to retrieve the passes, and give them to me, and I will open the portal. But be careful, one of them will lead you into a trap!"
        );
      } else if (status == 0) {
        // otherwise
        // check for stage completed
