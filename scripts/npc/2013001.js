    ...
    if (curMap == 1) {
      if (playerStatus) {
        ...
        if (status == 0) {
          ...
          if (cleared == null) {
            cm.sendNext(
              "Thank you for rescuing me. I will now teleport you to the <Door of the Goddess's Tower>."
            );
          } else {
      ...
      if (playerStatus) {
        ...
        if (
          thisMap.getReactorByName("scar1").getState() == 1 &&
          ...
          cm.sendOk(
            "Please fix the Goddess statue back up before clicking on me!"
          );
          cm.dispose();
        }
      } else {
      ...
      if (playerStatus) {
        ...
        if (premable == null) {
          ...
          if (complete != null) {
            cm.sendNext(
              "Please go back to the Center Tower and continue the quest."
            );
            cm.dispose();
          } else if (cm.haveItem(4001050, 30)) {
            cm.sendNext(
              "Thank you for bringing me back the 30 Small Pieces. I will make #bStatue of Goddess: 1st Piece#k right now."
            );
      ...
      if (playerStatus) {
        ...
        if (premable == null) {
          cm.sendNext(
            "This was formerly the storage area of the Tower of Goddess, but now, it has turned into a home of the Cellions. A Cellion took #bStatue of Goddess: 2nd#k Piece and hid with it, so it's your job to defeat it and bring back to the #bStatue of Goddess:2nd Piece#k.."
          );
          ...
          if (complete != null) {
            ...
            cm.sendNext(
              "Thank you for getting back the piece, use it to fix the Statue of Goddess."
            );
            clear(4, eim, cm);
            //   cm.givePartyQPoints(5 + curMap, party);
            cm.givePartyExp(7500, party);
            ...
            cm.sendNext(
              "You do not have the 2nd Statue Piece to clear this stage."
            );
            cm.dispose();
          }
        }
      ...
      if (playerStatus) {
        ...
        if (premable == null) {
          ...
          cm.getPlayer().dropMessage(
            "[" + cm.getServerName() + " Quest] Today is " + dayTxt + "."
          );
          ...
          if (complete != null) {
            ...
            eim.getMapInstance(920010400).getReactorByName("music").getMode() !=
            0
          ) {
      ...
      if (playerStatus) {
        ...
        if (premable == null) {
          cm.sendNext(
            "This is the lounge area of the Tower of Goddess, where the guests stayed for the night or two. #b<Statue of Goddess: 5th Piece>#k has been broken into 40 pieces, and separated all around the lounge. Please roam around and collect the pieces of the #b5th Small Pieces#k."
          );
          ...
          if (complete != null) {
            ...
            cm.sendNext(
              "Thank you for bringing me back the 40 Small Pieces. I will make #bStatue of Goddess: 5th Piece#k right now."
            );
      ...
      if (playerStatus) {
        ...
        if (premable == null) {
          cm.sendNext(
            "Since this stage is incomplete you can have the statue piece for free..."
          );
      ...
      cm.sendNext(
        "Argh, so dark here. You're now inside the Room of Darkness in the Tower of Goddess, but then, how did you get here? You won't find a piece of the Statue of Goddess here. I suggest you check out the other rooms instead."
      );
      cm.dispose();
    } else if (curMap == 999) {
      cm.warp(200080101, 0);
      ...
      if (status == 0) {
        ...
        if (preamble == null) {
          ...
          if (complete != null) {
            ...
            cm.sendNext(
              "Por favor, volte para o Centro da Torre e continue a missao."
            );
          } else {
            var totplayers = 0;
            ...
            if (totplayers == 5 /*|| debug*/) {
              ...
              if (testcombo || debug) {
                ...
                cm.getPlayer()
                  .getMap()
                  .setReactorState(
                    cm.getPlayer().getMap().getReactorByName("stone4"),
                    1
                  );
                cm.dispose();
              } else {
                ...
                if (tries > 6) {
                  cm.mapMessage(
                    5,
                    "Voce foi nanido do quarto Selado, e a combinacao deve ser reposta."
                  );
              ...
              if (debug) {
                ...
                cm.sendNext(
                  "Parece que voce nao tem encontrado as plataformas ainda, continue tentando!"
                );
              cm.dispose();
            }
          }
