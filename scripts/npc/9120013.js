...
function start() {
  ...
  answers = new Array(
    ...
    new Array("Cloud Fox's Tooth", "Ghost's Bouquet", "Dark Cloud Fox's Tail"),
...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0 && mode == 1) {
      if (
        cm.getQuestStatus(8012).equals(MapleQuestStatus.Status.STARTED) &&
        !cm.haveItem(4031064)
      ) {
        //quest in progress
        cm.sendYesNo(
