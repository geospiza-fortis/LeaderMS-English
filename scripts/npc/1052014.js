    ...
    if (cm.getPlayer().getMapId() == 230040200) {
      ...
      if (playerStatus) {
        if (status == 0) {
          ...
          if (preamble == null) {
            cm.sendNext(
              "Hello, welcome to the first stage of Aquarium PQ. See these squids here? Kill them and get me 200 passes in order to complete the first stage."
            );
            ...
            if (complete != null) {
              cm.sendNext(
                "Continue the mission; the portal has already been opened!"
              );
              cm.dispose();
            } else {
              if (cm.haveItem(4001022, 200) == false) {
                cm.sendNext(
                  "I'm sorry but you do not have all the 200 passes required to complete this phase."
                );
                cm.dispose();
              } else {
                cm.sendNext(
                  "Congratulations on completing the first stage. The portal will now open."
                );
                clear(1, eim, cm);
        ...
        if (status == 0 && preamble == null) {
          cm.sendNext(
            "Hello, welcome to the first stage of the Aquarium PQ. See these squids here? Kill them and give me 200 passes and to complete the first stage."
          );
        } else if (status == 0) {
          // otherwise
      ...
      if (playerStatus) {
        ...
        if (status == 0) {
          ...
          if (preamble == null) {
            cm.sendNext(
              "Welcome to the second stage of the Aquarium PQ. See these squids here? Kill them and give me 50 passes to complete the second stage."
            );
            ...
            if (complete != null) {
              cm.sendNext(
                "Continue the mission. The portal has already opened!"
              );
              cm.dispose();
            } else {
              if (cm.haveItem(4001022, 50) == false) {
                cm.sendNext(
                  "I'm sorry, but you do not have all 50 passes required to complete this stage."
                );
                cm.dispose();
              } else {
                cm.sendNext(
                  "Congratulations on completing the second stage! The portal will now open."
                );
                clear(2, eim, cm);
                //cm.givePartyQPoints(20, party);
      ...
      if (playerStatus) {
        ...
        if (status == 0) {
          ...
          if (preamble == null) {
            cm.sendNext(
              "Welcome to the third stage of the Aquarium PQ. See these squids here? Kill them and give me 150 passes to complete the third stage."
            );
            ...
            if (complete != null) {
              ...
              if (cm.haveItem(4001022, 150) == false) {
                cm.sendNext(
                  "I'm sorry, but you do not have all 150 passes required to complete this stage."
                );
                cm.dispose();
              } else {
                cm.sendNext(
                  "Congratulations on completing the third stage! The portal will now open."
                );
                clear(3, eim, cm);
                //cm.givePartyQPoints(20, party);
                cm.getPlayer()
      ...
      if (playerStatus) {
        ...
        if (status == 0) {
          ...
          if (preamble == null) {
            cm.sendNext(
              "Welcome to the final stage of the Aquarium PQ. See these squids here? Kill them and give me 300 passes to complete the final stage."
            );
            ...
            if (complete != null) {
              ...
              if (cm.haveItem(4001022, 300) == false) {
                cm.sendNext(
                  "I'm sorry, but you do not have all 300 passes required to complete this stage."
                );
                cm.dispose();
              } else {
                cm.sendNext(
                  "Congratulations on completing the final stage! I will now open the portal. Go forth and defeat the evil force of #bSuper Pianus#k."
                );
                clear(4, eim, cm);
                //cm.givePartyQPoints(20, party);
                cm.getPlayer()
