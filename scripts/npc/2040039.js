  ...
  if (mode == -1) {
    ...
    if (playerStatus) {
      ...
      if (status == 0) {
        ...
        if (preamble == null) {
          cm.sendNext(
            "Hello, and welcome to the fourth stage of Ludibrium PQ. There are #r8#k #bPasses#k to be collected in here, go through the portals and you'll see some Shadow Eyes. Kill them to retrieve the passes, and give them to me, and I will open the portal."
          );
          ...
          if (complete != null) {
            ...
            if (cm.haveItem(4001022, 8) == false) {
              cm.sendNext(
                "I'm sorry, but you do not have all 8 passes needed to clear this stage."
              );
              cm.dispose();
            } else {
              cm.sendNext(
                "Congratulations on clearing the fourth stage! I will open the portal now."
              );
              clear(1, eim, cm);
