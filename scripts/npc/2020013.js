  ...
  if (actionx["Mental"]) {
    if (status == 0)
      ...
      if (cm.getJob().equals(MapleJob.BRAWLER)) {
        ...
        cm.sendNext(
          "Great! You are now a #bMarauder#k. As a Marauder, you will learn some of the most sophisticated skills related to melee-based attacks. #bEnergy Charge#k is a skill that allows you to store your power and the damage you received into a special form of energy. Once this ball of energy is charged, you may use #bEnergy Blast#k to apply maximum damage against your enemies, and also use #bEnergy Drain#k to steal your enemy's HP to recover your own. #bTransformation#k will allow you to transform into a superhuman being with devastating melee attacks, and while transformed, you can use #bShockwave#k to cause a mini-earthquake and inflict massive damage to your enemies."
        );
      }
    ...
    cm.getQuestStatus(100102).equals(MapleQuestStatus.Status.STARTED)
  ) {
    cm.sendOk(
      "Go, talk with the #b#p2030006##k and bring me #i4031058# \r\n#b#t4031058##k."
    );
    cm.dispose();
  } else if (
    cm.getQuestStatus(100101).equals(MapleQuestStatus.Status.COMPLETED)
  ) {
    cm.sendOk(
      "Now, go see #b#p2030006##k and bring me #b#i4031058#\r\n#t4031058##k.You'll need to answer the #b#p2030006#s#k each and every question with honesty and conviction. Bring back the necklace, and I will help you to the next step forward. Good luck."
    );
    cm.dispose();
  } else if (
    ...
    cm.sendOk(
      "The mental half of the test can only start after you pass the physical part of the test. #b#t4031057##k will be the proof that you have indeed passed the test. I'll let \r\n#b#p1090000##k know in advance that you're making your way there, so get ready. It won't be easy, but I have the utmost faith in you. Good luck."
    );
    cm.dispose();
  } else {
