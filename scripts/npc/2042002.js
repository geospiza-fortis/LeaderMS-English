    ...
    if (cm.getPlayer().getMapId() == 980000010) {
      ...
      if (status == 0) {
        if (cm.getChar().getParty() != null) {
          var shiu =
            "Sorry for the loss... Yet, you have put up quite an good show! Your team work and battle skills were amazing! I'll be expecting the same effort next time!\r\n\r\nMonster Carnival Rank: ";
      ...
      if (status == 0) {
        cm.sendSimple(
          "Hello there, my name is Spieglemann, and I host the Monster Carnival. I am trying to find players who are willing to fight for there lives against each other in a fair competition, and that is why I host the Monster Carnival PQ.\r\n\r\n#L0#I would like to participate#l\r\n#L1#What is Monster Carnival?#l\r\n#L2#Detailed Information#l\r\n#L3#Trade Maple Coins for Equipment#l"
        );
      } else if (status == 1) {
        if (selection == 0) {
          if (
            ...
            cm.sendOk(
              "I'm sorry, but only the users within Level 30~50 may\r\n participate in Monster Carnival."
            );
            cm.dispose();
            return;
          }
          ...
          cm.sendOk(
            "Well it's simple, all you have to do is enter #bMonster Carnival#k and create a party. Once you created a party you could talk to me inside and you could choose a room to wait a receive fights against another party. Once your inside and fighting, you will be able to pick up potions to heal you or even pick up curse potions to curse the other team! You will receive #rCP#k when you fight and you can exchange those to spawn monsters for the other team or spawn curses on them or you could just buff yourself! But overall, your main goal is to achieve the most CP and be the winner. Enjoy!"
          );
          cm.dispose();
        } else if (selection == 3) {
          cm.openNpc(9100002);
