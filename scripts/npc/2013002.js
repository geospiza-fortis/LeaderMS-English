...
var itemArray = Array(
  ...
  2100003,
  2100004,
  2100005 /*End of Sacks*/,
  2061003,
  2060003,
  2060004,
  2061004 /*End of Arrows*/,
  2070006,
  2070005,
  2070007,
  2070004 /*End of Stars*/,
  2210000,
  2210001,
  2210002 /*End of Morph items*/
);
...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (cm.getPlayer().getMapId() == 920010100) {
      ...
      if (status == 0) {
        cm.sendNext(
          "Thank you for not only restoring the statue, but rescuing me, Minerva, from the entrapment. May the blessing of the goddess be with you till the end..."
        );
      } else if (status == 1) {
