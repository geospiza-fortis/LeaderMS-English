  ...
  if (mode == -1) {
    ...
    if (playerStatus) {
      ...
      if (status == 0) {
        ...
        if (preamble == null) {
          cm.sendNext(
            "Hello, and welcome to the fifth stage of Ludibrium PQ. There are #r24#k #bPasses#k to be collected in here, go through the portals and you'll see some Boxes. Break them to retrieve the passes, and give them to me, and I will open the portal."
          );
          ...
          if (complete != null) {
            ...
            if (cm.haveItem(4001022, 24) == false) {
              cm.sendNext(
                "I'm sorry, but you do not have all 32 passes needed to clear this stage."
              );
              cm.dispose();
            } else {
              cm.sendNext(
                "Congratulations on clearing the fifth stage! I will open the portal now."
              );
              clear(1, eim, cm);
