    ...
    if (status == 0) {
      cm.sendSimple(
        "Hello #e#h ##n, I am Ria, a " +
          ...
          cm.getPlayer().getCSPoints(4) +
          "#n) Cash / LeaderPoints (#e" +
      ...
      if (selection == 20) {
        ...
        if (cm.getPlayer().getCSPoints(2) >= 4) {
          ...
          cm.getPlayer().dropMessage(
            "[LeaderPoints] You lost (-4) LeaderPoints!"
          );
