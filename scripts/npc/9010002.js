...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendSimple(
      "So you want to hunt for them? Okay I'll warp you to the map.#b\r\n#L2#Warp me#b\r\n#L3#No thanks, I changed my mind"
    );
  } else if (selection == 3) {
    cm.sendOk("Okay.");
    cm.dispose();
