  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      if (!cm.isLeader()) {
        ...
        if (copns < 30) {
          cm.sendNext(
            "You must have 30 or more coupons to complete the quest."
          );
          cm.dispose();
        } else {
          cm.sendNext(
            "Wow, you picked up " +
              copns +
              " coupons! Congratulations! You will be taken to another map to get your #bEXP#k and Rolly will give you your rewards!"
          );
        }
      }
    } else if (status == 1) {
