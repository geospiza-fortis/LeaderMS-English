      ...
      if (selection == 0) {
        if (cm.getParty() == null) {
          ...
          if (next) {
            ...
            cm.sendNext(
              "Please make sure all of your members are qualified to begin my trials..."
            );
            cm.dispose();
          }
        }
        ...
        //Golden Tooth Collection [4000082]
        if (cm.getZakumLevel() >= 2) {
          if (!cm.haveItem(4000082, 30)) {
            ...
            if (
              ...
              cm.sendNext(
                "Thank you for the teeth!  Next time you see me, I'll be blinging harder than #rJaws#k!  Goodbye and good luck!"
              );
          ...
          cm.sendNext(
            "Please complete the earlier trials before attempting this one."
          );
          cm.dispose();
        }
      }
