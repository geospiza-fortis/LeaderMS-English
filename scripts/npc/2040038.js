  ...
  if (mode == -1) {
    ...
    if (playerStatus) {
      ...
      if (status == 0) {
        ...
        if (preamble == null) {
          cm.sendNext(
            "Hello, and welcome to the third stage of Ludibrium PQ. There are #r32#k #bBlocktopus#k in here, kill them to retrieve the passes, and give them to me, and I will open the portal."
          );
          ...
          if (complete != null) {
            ...
            if (cm.haveItem(4001022, 32) == false) {
              ...
              cm.sendNext(
                "Congratulations on clearing the third stage! I will open the portal now."
              );
              clear(1, eim, cm);
