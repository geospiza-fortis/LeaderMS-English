...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendNext(
      "                                  <#e" +
        cm.getServerName() +
        " 4.JOB#n>             \r\n\r\nOla #e#h ##n, eu sou a Carta a auxiliar do " +
        cm.getServerName() +
    ...
    cm.sendSimple(
      "Em qual classe gostaria de liberar as skills:" +
    ...
    /* HERO */
    if (
      cm.haveItem(4005000, 5) &&
      cm.haveItem(4005001, 5) &&
      cm.haveItem(4005002, 5) &&
      cm.haveItem(4005003, 5) &&
      cm.haveItem(4005004, 5) &&
      cm.haveItem(4001126, 5000) &&
      cm.haveItem(4000238, 200) &&
      cm.haveItem(4000243, 1) &&
      cm.haveItem(4000235, 1) &&
      cm.getPlayer().getMeso() > 25000000 &&
    ...
    if (
      ...
      cm.haveItem(4000235, 1) &&
      cm.getPlayer().getMeso() > 25000000 &&
      cm.getJob().equals(MapleJob.BUCCANEER)
    ) {
      /* Remover items */
      cm.gainItem(4005000, -5);
      cm.gainItem(4005001, -5);
    ...
    if (
      ...
      cm.haveItem(4000235, 1) &&
      cm.getPlayer().getMeso() > 25000000 &&
      cm.getJob().equals(MapleJob.CORSAIR)
    ) {
      /* Remover items */
      cm.gainItem(4005000, -5);
      cm.gainItem(4005001, -5);
