...
function allMonstersDead(eim) {
  ...
  eim.broadcastPlayerMsg(
    5,
    "Your team gained " + num + " points! With a total of " + totalp + "."
  );
  ...
  if (mobnum < monster.length) {
    eim.broadcastPlayerMsg(
      6,
      "Prepare! The next boss will appear in a glimpse of an eye!"
    );
  } else {
    ...
    eim.broadcastPlayerMsg(
      5,
      "Your team beaten the HELL mode and have gained an extra 1,200,000 points and extra 850,000 Cash!"
    );
