  ...
  private void broadCastTV(boolean active) {
    ...
    try {
      if (active) {
        cserv
          .getWorldInterface()
          .broadcastMessage(null, MaplePacketCreator.enableTV().getBytes());
        cserv.getWorldInterface().broadcastMessage(null, packet.getBytes());
      } else {
        cserv
          .getWorldInterface()
          .broadcastMessage(null, MaplePacketCreator.removeTV().getBytes());
        packet = null;
      }
