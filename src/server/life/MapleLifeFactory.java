...
public class MapleLifeFactory {
  ...
  private static MapleDataProvider stringDataWZ = MapleDataProviderFactory.getDataProvider(
  ...
  public static MapleMonster getMonster(int mid) {
    ...
    if (stats == null) {
      MapleData monsterData = data.getData(
        StringUtil.getLeftPaddedStr(Integer.toString(mid) + ".img", '0', 11)
      );
      if (monsterData == null) {
        return null;
      }
      ...
      stats.setUndead(
        MapleDataTool.getIntConvert("undead", monsterInfoData, 0) > 0
      );
      stats.setName(
      ...
      if (stats.isBoss() || mid == 8810018) {
        ...
        if (hpTagBgColor == null || hpTagColor == null) {
          ...
          stats.setTagColor(
            MapleDataTool.getIntConvert("hpTagColor", monsterInfoData)
          );
          stats.setTagBgColor(
