...
public class MapleShop {
  ...
  public void buy(MapleClient c, int itemId, short quantity) {
    ...
    if (
      ...
      if (MapleInventoryManipulator.checkSpace(c, itemId, quantity, "")) {
        ...
        c
          .getSession()
          .write(MaplePacketCreator.confirmShopTransaction((byte) 0));
      } else {
        c
          .getSession()
          .write(MaplePacketCreator.confirmShopTransaction((byte) 3));
      }
    }
  }
  ...
  public void sell(
    ...
    if (quantity <= iQuant && iQuant > 0) {
      ...
      c
        .getSession()
        .write(MaplePacketCreator.confirmShopTransaction((byte) 0x8));
    }
  }
  ...
  public void recharge(MapleClient c, byte slot) {
    ...
    if (
      ...
      if (
        ...
        log.warn(
          c.getPlayer().getName() + " is trying to recharge " + item.getItemId()
        );
      }
      return;
    }
