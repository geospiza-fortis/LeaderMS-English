...
public class PlayerNPCWorker implements Runnable {
  ...
  public static void updatePlayerNPC(String charname) {
    try {
      ...
      String query =
        "SELECT id, skincolor, hair, face FROM characters WHERE name=?";
      String query1 =
        "SELECT itemid, position FROM inventoryitems WHERE characterid=? AND inventorytype = '-1' ORDER BY position DESC";
      ...
      String uq =
        "UPDATE playernpcs SET hair = ?, face = ?, skin = ? WHERE name = ?";
      ...
      while (rs.next()) {
        ...
        if (rs.getInt("position") == -1 || rs.getInt("position") == -101) {
          ...
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
              "DELETE FROM playernpcs_equip WHERE npcid = ? AND equippos = ?"
            );
            sss.setInt(1, npcid);
          ...
          rs.getInt("position") == -2 || rs.getInt("position") == -102
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -3 || rs.getInt("position") == -103
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -4 || rs.getInt("position") == -104
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -5 || rs.getInt("position") == -105
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -6 || rs.getInt("position") == -106
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -7 || rs.getInt("position") == -107
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -8 || rs.getInt("position") == -108
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -9 || rs.getInt("position") == -109
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          rs.getInt("position") == -10 || rs.getInt("position") == -110
        ) {
          pos = rs.getInt("position");
          if (pos > 100) { //NS check
            PreparedStatement sss = con.prepareStatement(
          ...
          pos = rs.getInt("position");
          PreparedStatement sss = con.prepareStatement(
            "DELETE FROM playernpcs_equip WHERE npcid = ? AND equippos = 11"
          );
          sss.setInt(1, npcid);
          sss.executeUpdate();
          sss.close();
        ...
        update =
          con.prepareStatement(
            "INSERT INTO playernpcs_equip(npcid, equipid, equippos, type) VALUES (?, ?, ?, 0);"
          );
  ...
  public static void updateAllNPCs() throws SQLException {
    ...
    PreparedStatement query = con.prepareStatement(
      "SELECT * FROM playernpcs WHERE name != '';"
    );
