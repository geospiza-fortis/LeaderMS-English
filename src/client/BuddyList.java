...
public class BuddyList {
  ...
  public void loadFromDb(int characterId) throws SQLException {
    ...
    PreparedStatement ps = con.prepareStatement(
      "SELECT b.buddyid, b.pending, c.name as buddyname FROM buddies as b, characters as c WHERE c.id = b.buddyid AND b.characterid = ?"
    );
  ...
  public void addBuddyRequest(
    ...
    if (pendingRequests.isEmpty()) {
      c
        .getSession()
        .write(MaplePacketCreator.requestBuddylistAdd(cidFrom, nameFrom));
    } else {
