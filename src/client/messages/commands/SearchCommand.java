    ...
    if (splitted.length == 1) {
      ...
      if (type.equalsIgnoreCase("NPC") || type.equalsIgnoreCase("NPCS")) {
        ...
        for (MapleData npcIdData : data.getChildren()) {
          ...
          npcPairList.add(
            new Pair<Integer, String>(npcIdFromData, npcNameFromData)
          );
        }
        ...
        for (MapleData mapAreaData : data.getChildren()) {
          for (MapleData mapIdData : mapAreaData.getChildren()) {
            ...
            mapPairList.add(
              new Pair<Integer, String>(mapIdFromData, mapNameFromData)
            );
          }
        }
        ...
        for (MapleData mobIdData : data.getChildren()) {
          ...
          mobPairList.add(
            new Pair<Integer, String>(mobIdFromData, mobNameFromData)
          );
        }
        ...
        for (MapleData skillIdData : data.getChildren()) {
          ...
          skillPairList.add(
            new Pair<Integer, String>(skillIdFromData, skillNameFromData)
          );
        }
