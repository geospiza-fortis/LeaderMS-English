...
public class PetDataFactory {
  ...
  private static MapleDataProvider dataRoot = MapleDataProviderFactory.getDataProvider(
  ...
  public static PetCommand getPetCommand(int petId, int skillId) {
    PetCommand ret = petCommands.get(
      new Pair<Integer, Integer>(
        Integer.valueOf(petId),
    ...
    synchronized (petCommands) {
      ...
      if (ret == null) {
        ...
        if (skillData != null) {
          prob =
            MapleDataTool.getInt("interact/" + skillId + "/prob", skillData, 0);
          inc =
            MapleDataTool.getInt("interact/" + skillId + "/inc", skillData, 0);
        }
