...
public class PetPacket {
  ...
  public static MaplePacket updatePet(MaplePet pet, boolean alive) {
    ...
    if (alive) {
      mplew.writeLong(
        PacketHelper.getKoreanTimestamp(
          (long) (System.currentTimeMillis() * 1.5)
        )
      );
      mplew.writeInt(0);
    } else {
  ...
  public static MaplePacket showPet(
    MapleCharacter chr,
    MaplePet pet,
    boolean remove
  ) {
  ...
  public static MaplePacket movePet(
    int cid,
    int pid,
    int slot,
  ...
  public static MaplePacket commandResponse(
    int cid,
    byte command,
    int slot,
    boolean success,
  ...
  public static MaplePacket changePetName(
    MapleCharacter chr,
    String newname,
    int slot
  ) {
