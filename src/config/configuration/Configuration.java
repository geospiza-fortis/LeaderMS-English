...
public class Configuration {
  ...
  /*   Login Messages     */
  public static final String Player_Login =
    "Welcome back. Don't forget to vote for our server (#r#e" +
    Configuration.Server_Name +
    "#k#n).";
  public static final String Player_Newcomer =
    "Hello beginner, use the command @commands and enjoy the game.";
  public static final String Player_Buffed =
    "<You have been buffed by LeaderBot>";
  ...
  public static boolean isForceRespawn(int mapid) {
    switch (mapid) {
      ...
      default:
        return (
          mapid / 100000 == 9800 && (mapid % 10 == 1 || mapid % 1000 == 100)
        );
    }
  }
