 ...
 * @author Matze
 */
public interface WorldChannelInterface
  extends Remote, WorldChannelCommonOperations {
  ...
  MapleMessenger createMessenger(MapleMessengerCharacter chrfor)
    throws RemoteException;
  ...
  public void addAlliance(int id, MapleAlliance addAlliance)
    throws RemoteException;
