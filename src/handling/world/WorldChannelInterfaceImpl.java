 ...
 * @author Matze
 */
public class WorldChannelInterfaceImpl
  ...
  public WorldChannelInterfaceImpl(ChannelWorldInterface cb, int dbId)
  ...
  public Properties getGameProperties() throws RemoteException {
    ...
    try {
      ...
      PreparedStatement ps = con.prepareStatement(
        "SELECT * FROM channelconfig WHERE channelid = ?"
      );
      ps.setInt(1, dbId);
  ...
  public void serverReady() throws RemoteException {
    ready = true;
    for (LoginWorldInterface wli : WorldRegistryImpl
      .getInstance()
      .getLoginServer()) {
      try {
  ...
  public String getIP(int channel) throws RemoteException {
    ChannelWorldInterface cwi = WorldRegistryImpl
      .getInstance()
      .getChannel(channel);
    if (cwi == null) {
  ...
  public void shutdown(int time) throws RemoteException {
    for (LoginWorldInterface lwi : WorldRegistryImpl
      .getInstance()
      .getLoginServer()) {
      try {
        lwi.shutdown();
  ...
  public void loggedOff(
    ...
    for (int i : WorldRegistryImpl.getInstance().getChannelServer()) {
      final ChannelWorldInterface cwi = WorldRegistryImpl
        .getInstance()
        .getChannel(i);
      try {
  ...
  @Override
  public CharacterIdChannelPair[] multiBuddyFind(
    int charIdFrom,
    int[] characterIds
  ) throws RemoteException {
    List<CharacterIdChannelPair> foundsChars = new ArrayList<CharacterIdChannelPair>(
      characterIds.length
    );
    for (int i : WorldRegistryImpl.getInstance().getChannelServer()) {
      ChannelWorldInterface cwi = WorldRegistryImpl.getInstance().getChannel(i);
  ...
  @Override
  public void setGuildMemberOnline(
  ...
  public void setGuildEmblem(
    ...
    WorldRegistryImpl
      .getInstance()
      .setGuildEmblem(gid, bg, bgcolor, logo, logocolor);
  }
  ...
  public void leaveMessenger(int messengerid, MapleMessengerCharacter target)
    throws RemoteException {
    MapleMessenger messenger = WorldRegistryImpl
      .getInstance()
  ...
  public void silentLeaveMessenger(
    int messengerid,
    MapleMessengerCharacter target
  ) throws RemoteException {
    MapleMessenger messenger = WorldRegistryImpl
  ...
  public void silentJoinMessenger(
    int messengerid,
    MapleMessengerCharacter target,
    int position
  ) throws RemoteException {
  ...
  public void addBuffsToStorage(int chrid, List<PlayerBuffValueHolder> toStore)
    throws RemoteException {
    PlayerBuffStorage buffStorage = WorldRegistryImpl
      .getInstance()
  ...
  public void addCooldownsToStorage(
    int chrid,
    List<PlayerCoolDownValueHolder> toStore
  ) throws RemoteException {
    PlayerBuffStorage buffStorage = WorldRegistryImpl
      .getInstance()
      .getPlayerBuffStorage();
  ...
  public void allianceMessage(
    ...
    WorldRegistryImpl
      .getInstance()
      .allianceMessage(id, packet, exception, guildex);
  }
  ...
  public boolean removeGuildFromAlliance(int aId, int guildId)
    throws RemoteException {
    return WorldRegistryImpl
      .getInstance()
      .removeGuildFromAlliance(aId, guildId);
  }
