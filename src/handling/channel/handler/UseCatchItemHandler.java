      ...
      c
        ...
        .write(
          MaplePacketCreator.serverNotice(
            5,
            "You cannot use the rock right now."
          )
        );
        ...
        { // Characteristic Stone
          ...
          if (
            ...
            c
              ...
              .dropMessage(
                1,
                "This item is not available for use outside the AriantPQ!"
              );
            c.getSession().write(MaplePacketCreator.enableActions());
            return;
          }
          if (mob.getHp() <= mob.getMaxHp() / 2) {
            c
              ...
              .getMap()
              .broadcastMessage(
                MaplePacketCreator.catchMonster(oid, itemid, (byte) 1)
              );
            ...
            c
              .getSession()
              .write(MaplePacketCreator.serverNotice(5, "You won a jewel!"));
            ...
            c
              ...
              .getMap()
              .broadcastMessage(
                MaplePacketCreator.catchMonster(oid, itemid, (byte) 0)
              );
            c
              .getPlayer()
              .dropMessage(
