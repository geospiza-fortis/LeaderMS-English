...
public class RingActionHandler extends AbstractMaplePacketHandler {
  ...
  public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
    ...
    switch (mode) {
      case 0x00: //Send
        if (
          (System.currentTimeMillis() - player.getLatestMarriageRequest()) >
          60000
        ) {
          String partnerName = slea.readMapleAsciiString();
          MapleCharacter partner = c
            .getChannelServer()
            .getPlayerStorage()
          ...
          if (partnerName.equalsIgnoreCase(player.getName())) {
            ...
            NPCScriptManager
              .getInstance()
              .start(partner.getClient(), 9201002, "marriagequestion", player);
          }
          ...
          c
            ...
            .write(
              MaplePacketCreator.serverNotice(
                1,
                "You cannot send another marriage request until a minute is up"
              )
            );
        ...
        if (player.getPartner() != null) {
          ...
          c
            ...
            .write(
              MaplePacketCreator.serverNotice(
                1,
                "Your engagement has been broken up."
              )
            );
          break;
        } else {
