      ...
      c
        ...
        .write(
          MaplePacketCreator.serverNotice(
            5,
            "JR GameMasters cannot pick up items."
          )
        );
      return;
    }
    if (ob instanceof MapleMapItem) {
      ...
      synchronized (mapitem) {
        ...
        if (distance > 90000.0) { // 300^2, 550 is approximatly the range of ultis
          ...
          if (c.getPlayer().getCheatTracker().getPoints() > 50) c
            .getPlayer()
            .getClient()
            .getSession()
            .close();
              ...
              c
                ...
                .broadcastGMMessage(
                  ...
                  MaplePacketCreator
                    .serverNotice(
                      5,
                      c.getPlayer().getName() + " is looting while dead."
                    )
                    .getBytes()
                );
            ...
            if (mapitem.getItem().getItemId() == (Integer) pair.getLeft()) {
              ...
              c
                ...
                .write(
                  MaplePacketCreator.serverNotice(
                    5,
                    "[Cash System] You gained NX (+" + necksonGain + ")."
                  )
                );
        ...
        if (mapitem.getMeso() > 0) {
          if (c.getPlayer().getParty() != null) {
            ...
            for (MaplePartyCharacter partymem : c
              ...
              if (
                partymem.isOnline() &&
                partymem.getMapid() == c.getPlayer().getMap().getId() &&
          ...
          mapitem.getItem().getItemId() >= 2022157 &&
          mapitem.getItem().getItemId() <= 2022178
        ) {
          ...
          if (
            mapitem.getItem().getItemId() == 2022157 ||
            mapitem.getItem().getItemId() == 2022158 ||
            mapitem.getItem().getItemId() == 2022159
          ) {
          ...
          if (
            mapitem.getItem().getItemId() == 2022160 ||
            mapitem.getItem().getItemId() == 2022161 ||
            mapitem.getItem().getItemId() == 2022162 ||
            mapitem.getItem().getItemId() == 2022163
          ) {
            ii
              .getItemEffect(mapitem.getItem().getItemId())
              .applyTo(c.getPlayer());
            if (c.getPlayer().getParty() != null) {
              for (
                int i = 0;
                i < c.getPlayer().getParty().getMembers().size();
                i++
              ) {
                MapleCharacter chr = c
                  ...
                  .getPlayerStorage()
                  .getCharacterById(
                    c.getPlayer().getParty().getMemberByPos(i).getId()
                  );
                if (chr != null) ii
                  .getItemEffect(mapitem.getItem().getItemId())
                  .applyTo(chr);
            ...
            mapitem.getItem().getItemId() == 2022164 ||
            mapitem.getItem().getItemId() == 2022165 ||
            mapitem.getItem().getItemId() == 2022166
          ) { // || mapitem.getItem().getItemId() == 2022174 || mapitem.getItem().getItemId() == 2022175 || mapitem.getItem().getItemId() == 2022176 || mapitem.getItem().getItemId() == 2022177 || mapitem.getItem().getItemId() == 2022178) {
            //Debuff Givers
            MapleDisease canDo[] = {
            ...
            int skills[] = { 121, 120, 123, /*125,*/126, 122 };
            ...
            if (mapitem.getItem().getItemId() == 2022164) {
                ...
                MapleCharacter chr = c
                  ...
                  .getCharacterById(
                    c
                      ...
                      .getParty()
                      .getEnemy()
                      .getMemberByPos(randd)
                      .getId()
                  );
                if (chr != null) chr.giveDebuff(toCast, skill, true);
              }
              c.getSession().write(MaplePacketCreator.enableActions());
              ...
              if (c.getPlayer().getParty().getEnemy() != null) {
                for (
                  int i = 0;
                  i < c.getPlayer().getParty().getEnemy().getMembers().size();
                  i++
                ) {
                  MapleCharacter chr = c
                    .getChannelServer()
              ...
              if (enemy != null) {
                ...
                if (chr != null) chr.giveDebuff(MapleDisease.STUN, skill, true);
              }
              c.getSession().write(MaplePacketCreator.enableActions());
            }
          } else if (
            mapitem.getItem().getItemId() == 2022174 ||
            mapitem.getItem().getItemId() == 2022175 ||
            mapitem.getItem().getItemId() == 2022176 ||
            mapitem.getItem().getItemId() == 2022177 ||
            mapitem.getItem().getItemId() == 2022178
          ) {
            //Use Pots only on me
            ii
          ...
          mapitem.getItem().getItemId() >= 2022266 &&
          mapitem.getItem().getItemId() <= 2022269
        ) {
          if (
            mapitem.getItem().getItemId() == 2022266 ||
            mapitem.getItem().getItemId() == 2022267
          ) {
            c
              .getPlayer()
              .getMap()
          ...
          if (
            mapitem.getItem().getItemId() >= 5000000 &&
            ...
            if (
              MapleInventoryManipulator.addFromDrop(
                c,
                mapitem.getItem(),
                "Picked up by " + c.getPlayer().getId(),
                true
              )
            ) {
              c
